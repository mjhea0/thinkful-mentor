class Wheel(object):
    ...
    def __repr__(self):
        return "wheel model name is {}, wheel weight is {}lbs per wheel, wheel manufacturing cost is ${}.00 per wheel".format(
            self.wheel_name, self.wheel_weight, self.wheel_cost)
...
class Frame(object):
    ...
    def __repr__(self):
        return "frame is made of {}, weight of the frame is {}lbs and manufacturing cost of the frame is ${}.00".format(
            self.material, self.frame_weight, self.frame_cost)


class Bicycle(object):

    def __init__(self, wheel_name, wheel_weight,
            wheel_cost, frame_weight, frame_cost, frame_code,
            bicycle_name, manufacturer, manufacturer_margin):
    ...
    def __repr__(self):
        return "{}, the manufacturer of this bicycle model is {}, {}, {}\n".format(
            self.bicycle_name, self.manufacturer, self.wheel, self.frame)
...
class Manufacturer(object):
    ...
    def __repr__(self):
        return 'name of the manufacturer is {}, manufacturer margin is {}, the models it manufacturers are {}'.format(
            self.manufacturer_name, self.manufacturer_margin, self.models)
...
class BikeShop(object):
    ...
    def __repr__(self):
        return 'name of the bike shop is {}, bike shop margin is {}, bike shop\'s inventory is {}'.format(
            self.bikeshop_name, self.retail_margin, self.inventory)
    ...
    def bikeweight(self):
        ...
        for bike in self.inventory:
            print "bicycle model name is {} and total weight is {}lbs\n".format(
                bike.bicycle_name, bike.total_weight())

    def affordable_bikes(self, customer):
        """
        lists bikes the customer can afford within their budget,
        customer purchases most expensive within budget
        """
        affordable_bikes = []
        for bike in self.inventory:
        ...
        return "{} buys {} for ${} and her fund balance is ${}\n".format(
            customer.customer_name, purchase, paid, customer_fund_balance)
...
class Customer(object):
    ...
    def __repr__(self):
        return "name of the customer is {}, customer\'s bike fund is ${}".format(
            self.customer_name, self.fund)
