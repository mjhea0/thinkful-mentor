...
class Nickname(Base):
    ...
    id = Column(Integer, primary_key=True)
    name = Column(String, nullable=False)
    pet = relationship('Pet', secondary='pet_nickname_association', backref='nicknames', cascade="all, delete-orphan", single_parent=True, passive_deletes=True)
...
if __name__ == "__main__":
    ...
    ### Test our cascade
    db_session.delete(spot.breed.species)
    db_session.commit()
